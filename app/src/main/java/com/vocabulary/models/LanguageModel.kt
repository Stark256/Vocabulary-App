...
class LanguageModel(
    ...
    fun getContentValues() : ContentValues {
        return ContentValues().apply {
          ...
          put(key_table_exercise_fails, tableExerciseFails)
        }
    }
    ...
    companion object {
        ...
        val TABLE_FIELDS: ArrayList<DBField> = arrayListOf(
            ...
            DBField(key_table_exercise_fails, type_table_exercise_fails)
        )
    }
}
